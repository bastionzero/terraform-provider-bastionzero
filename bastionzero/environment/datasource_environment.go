...
func NewEnvironmentDataSource() datasource.DataSource {
	return bzdatasource.NewSingleDataSource(&bzdatasource.SingleDataSourceConfig[environmentModel, environments.Environment]{
		...
		GetAPIModel: func(ctx context.Context, client *bastionzero.Client, id string) (*environments.Environment, error) {
			env, _, err := client.Environments.GetEnvironment(ctx, id)
			return env, err
		},
